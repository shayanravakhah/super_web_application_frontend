            ...
            <div className=" w-full mt-48 mb-20 flex items-center justify-center bg-white flex-col px-5">
                <div className="w-full md:w-2/3 lg:w-1/2 border border-black rounded-lg ">
                    ...
                    <div className='flex flex-col items-center'>
                        ...
                        <TextField error={errors[1]} label="Email" value={email} onChange={(e) => setEmail(e.target.value)} className='w-5/6  my-2 lg:w-2/3  ' />
                        ...
                        />
                        <TextField error={errors[3]} label="Age" type="number" value={age} onChange={(e) => setAge(e.target.value)} className='w-5/6 my-2 lg:w-2/3' />
                        <TextField error={errors[4]} label="Nationality" type="text" value={nationality} onChange={(e) => setNationality(e.target.value)} className='w-5/6 my-2 lg:w-2/3' />
                        <TextField error={errors[5]} label="URL Profile" type="email" value={email} onChange={(e) => setEmail(e.target.value)} className='w-5/6 my-2 lg:w-2/3' placeholder="Please Enter URL of your profile" />
